    ...
    <div className="max-w-6xl mx-auto my-16 px-4">
      ...
      <div className="bg-gradient-to-r from-[#3f6197] to-[#5478b0] rounded-3xl shadow-2xl p-8 mb-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-3 tracking-tight">Press & Media Coverage</h1>
          <p className="text-blue-100 text-lg md:text-xl max-w-2xl">Stay updated with news, articles, and media mentions featuring our incubation center and portfolio startups</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-10 border border-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Filter by Source</label>
      ...
      {(filters.source !== 'All' || filters.searchTerm) && (
        <div className="flex flex-wrap gap-2 mb-8">
          <div className="bg-blue-50 rounded-xl p-3 shadow-sm border border-blue-100 flex items-center gap-3">
            <span className="text-sm font-medium text-[#3f6197]">Active filters:</span>
      ...
      {error && !loading && (
        <div className="bg-red-50 p-8 rounded-2xl border border-red-100 text-center shadow-lg mb-8">
          ...
          <h3 className="text-red-800 text-xl font-bold mb-2">Unable to Load Media</h3>
      ...
      {!loading && !error && mediaCoverage.length === 0 && (
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-10 rounded-2xl border border-blue-100 text-center shadow-lg">
          <div className="bg-white/70 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-[#3f6197]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
            </svg>
          </div>
          <h3 className="text-[#3f6197] text-2xl font-bold mb-3">No Media Coverage Found</h3>
          <p className="text-gray-700 mb-6 max-w-lg mx-auto">We couldn't find any articles matching your current filters. Try adjusting your search criteria or check back later for new updates.</p>
          <button 
            onClick={resetFilters}
      ...
      <div className="mt-16 bg-gradient-to-br from-[#3f6197] to-[#2c4b79] rounded-2xl p-8 shadow-xl">
        <div className="md:flex items-center justify-between">
          <div className="md:w-3/5 mb-6 md:mb-0">
            ...
            <p className="text-blue-100">Subscribe to our newsletter to receive the latest press coverage and announcements directly in your inbox.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#3f6197]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
              </svg>
            </div>
            <h3 className="text-xl font-bold text-gray-800">{pagination.totalItems}+</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-800">{sources.length - 1}</h3>
