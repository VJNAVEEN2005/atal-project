...
import { fetchRoadmap } from "../../Redux/slice/roadmapSlice";
...
const Road_Map = () => {
  ...
  useEffect(() => {
    if (state.roadmap.roadmap) {
      const organizedData = {};
      state.roadmap.roadmap.roadmapItems.forEach((item) => {
  ...
  const filteredEvents =
    selectedYear && timelineData[selectedYear]
      ? timelineData[selectedYear].map((event) => ({
          ...event,
          year: selectedYear,
        }))
      : [];
              ...
              >
                ...
                <div
                  className={`ml-16 md:ml-0 bg-white rounded-lg shadow-sm p-6 ${
                    index % 2 === 0
                      ? "md:mr-auto md:ml-0 md:pr-12 text-right"
  ...
  return (
    <div className="py-16 bg-gradient-to-b from-white to-blue-50 md:m-5 m-1 shadow-xl min-w-[80%] rounded-lg">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold text-[#3f6197] mb-4">
            Our Journey
          </h2>
          <div className="h-1 w-24 bg-[#3f6197] mx-auto mb-6"></div>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore the milestones that have shaped our growth and impact in the
            startup ecosystem
          </p>
        </motion.div>
              ...
              >
                {filteredEvents.map((event, index) => (
                  <motion.div
                    ...
                    whileHover="hover"
                    onHoverStart={() =>
                      setHoveredItem(`${event.year}-${event.month}-${index}`)
                    }
        ...
        >
          <h3 className="text-2xl font-bold text-[#3f6197] mb-6 text-center">
            Journey in Numbers
          </h3>
