  ...
  return (
    <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        {/* Render Core Team */}
        <div className="mt-12">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Core Team</h3>
        ...
        <div className="mt-12">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Executive Team</h3>
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
