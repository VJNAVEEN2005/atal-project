            ...
            >
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  This Program is suited for early stage startups in the
                  ideation stage, problem identification stage, idea validation
                  stage or prototype stage, and are unable to take their ideas
                  to the next stage.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Selected teams will undergo 12-week pre-incubation program,
                  during which they will be engaged in various sessions,
                  workshops, peer-to-peer learning activities.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Post-pre-incubation, the startups will be given an opportunity
                  to pitch to AIC-PECF for a 24-month incubation journey.
                </p>
              </motion.div>
            </motion.div>
          </div>
